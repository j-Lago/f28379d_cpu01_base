...
namespace fast_math
{
    const float um_pi = 0.31830988618379067153776752674503f;
    const float um_pi2 = 0.1591549430918953357688837633725f;
    const float pi = 3.1415926535897932384626433832795f;
    const float pi2 = 6.283185307179586476925286766559f;
    const float pi_2 = 1.5707963267948966192313216916398f;
    const float deg_rad = 0.01745329251994329576923690768489f;
    const float rad_deg = 57.29577951308232087679815481410f;
};



/*
 * armazena angulo th como [cos(th), sin(th)]
 */
template<typename T>
class CiS
{
