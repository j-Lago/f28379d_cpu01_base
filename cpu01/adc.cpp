...
//
// Interrup��o chamada quando convers�o do ADCA excecer limite predefinido em OVERCURRENT
//
...
//
// Interrup��o chamada quando convers�o do ADCB excecer limite predefinido em OVERCURRENT
//
...
void ADC::setup()
{
    ...
    PieVectTable.ADCA1_INT = &adca1_isr; // mapeia a fun��o a ser chamada pela interrup��o do ADCA
